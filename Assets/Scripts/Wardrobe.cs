...
public class Wardrobe : MonoBehaviour
{
    ...
    private void HidePlayer()
    {
        ...
        if (playerController != null && playerController.cameraHolder != null)
        {
            previousCameraPosition = playerController.cameraHolder.position;
            previousCameraRotation = playerController.cameraHolder.rotation;
        }
    ...
    private void ExitWardrobe()
    {
        ...
        if (playerController != null && playerController.cameraHolder != null)
        {
            playerController.cameraHolder.position = previousCameraPosition;
            playerController.cameraHolder.rotation = previousCameraRotation;
        }
